...
const Skills = () => {
  const skills = [
    ...
    'Sass/SCSS', 'Tailwind CSS', 'Bootstrap', 'Node.js', 'Python', 'Express.js', 
    'REST APIs', 'GraphQL', 'PostgreSQL', 'MongoDB', 'MySQL', 'Firebase', 
    'Git', 'Webpack', 'Vite', 'Docker', 'CI/CD', 'Jest', 'Testing', 'Figma', 
    'Adobe XD', 'UI/UX Design', 'Responsive Design', 'Mobile-First Design', 
    'Accessibility', 'Prototyping', 'Wireframing'
  ];
